...
<section class="section">
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">
                        <h4>Data Cutoff: 9 Maret 2025</h4>
                    </a></div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h3>Rekening Valid (Konfirmasi Info GTK)</h3>
                    </div>
                    <div class="card-body">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/chocolat/1.1.3/js/chocolat.min.js" integrity="sha512-Ig2krV9g4BtBJQE9qiC8OhYQKTfkjeND2ION1QnKonBACvjw6kLO6SqW+C7xuA7ols+jyQDGb7tfizZwN9IrbQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  ...
  <script src=" {{ asset('assets/modules/js/2.425f42b7.chunk.js') }}></script>
